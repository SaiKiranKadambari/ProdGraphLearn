...
rmpath ./misc/
%%
figure(1);clf;surf(gamma2, gamma1, NMI_Lp);%title('Lp');
colorbar
xlabel('$\gamma_2$', 'Interpreter','latex');
ylabel('$\gamma_1$', 'Interpreter','latex');
zlabel('\texttt{NMI}',  'Interpreter','latex');
set(gca,'FontSize',10);

figure(2);clf;surf(gamma2, gamma1, NMI_Lq);%title('Lp');
colorbar
xlabel('$\gamma_2$', 'Interpreter','latex');
ylabel('$\gamma_1$', 'Interpreter','latex');
zlabel('\texttt{NMI}',  'Interpreter','latex');
...
figure(3);clf;surf(gamma2, gamma1, NMI_L);%title('L');
colorbar
xlabel('$\gamma_2$', 'Interpreter','latex');
ylabel('$\gamma_1$', 'Interpreter','latex');
zlabel('\texttt{NMI}',  'Interpreter','latex');
...
figure(4);clf;imagesc(gamma2, gamma1, NMI_Lp);%title('Lp');
colorbar
xlabel('$\gamma_2$', 'Interpreter','latex');
ylabel('$\gamma_1$', 'Interpreter','latex');
zlabel('\texttt{NMI}',  'Interpreter','latex');
...
figure(5);clf;imagesc(gamma2, gamma1, NMI_Lq);%title('Lq');
colorbar
xlabel('$\gamma_2$', 'Interpreter','latex');
ylabel('$\gamma_1$', 'Interpreter','latex');
zlabel('\texttt{NMI}',  'Interpreter','latex');
...
figure(6);clf;imagesc(gamma2, gamma1, NMI_L);%title('L');
colorbar
xlabel('$\gamma_2$', 'Interpreter','latex');
ylabel('$\gamma_1$', 'Interpreter','latex');
zlabel('\texttt{NMI}',  'Interpreter','latex');
...
figure(1);print('-depsc', 'RPGL_HyperParam_Surf_Lp.eps');
figure(2);print('-depsc', 'RPGL_HyperParam_Surf_Lq.eps');
figure(3);print('-depsc', 'RPGL_HyperParam_Surf_Ln.eps');

figure(4);print('-depsc', 'RPGL_HyperParam_ImSc_Lp.eps');
figure(5);print('-depsc', 'RPGL_HyperParam_ImSc_Lq.eps');
figure(6);print('-depsc', 'RPGL_HyperParam_ImSc_Ln.eps');
%%
