...
% In this code we are setting k2 by varying while fixing k1. 
% Best K2 should occur at 3
...
xlabel('$K_P$', 'Interpreter','latex')
ylabel('${\mathrm{tr}}(\textbf{V}^T_P \textbf{L}_P \textbf{V}_P )$',  'Interpreter','latex')
set(gca,'FontSize',12);
%%
% zzz2 = mean(Res_Lp,2);
% figure(2);clf;plot(kVal,(zzz2),'k', 'LineWidth', 2); hold on
