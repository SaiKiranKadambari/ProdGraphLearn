...
% This script should generate the paper ready figures for the Fig.5 of the
% paper

% Figure 5: 
% 5a. In the KronFactorization RPGL method run 1000 iterations and plot the error.
% 5b. RPGL - given data(learning part) 1000 iters plot error
% 1 ----> Red dashed marker + 
% 2 ----> RPGL given data dashed black
...
figure(3);clf;loglog(error,'--k','LineWidth',2);
xlabel('Number of iterations')
ylabel('Error')
set(gca,'FontSize',12);
print('-depsc', 'RPGL_ErrorPlot.eps');
%% RPGL - given data(learning part) 1000 iters plot error (dashed black)
figure(4);clf;loglog(objec,'--k','LineWidth',2);title('Objective function')
xlabel('Number of iterations')
